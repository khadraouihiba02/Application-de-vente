...
namespace Application_de_vente.Migrations
{
    ...
    [Migration("20260720134515_RefonteSaisieVolsCrews")]
    partial class RefonteSaisieVolsCrews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationDeVente.Models.CrewAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationDeVente.Models.CrewAssignment", b =>
                {
                    b.HasOne("ApplicationDeVente.Models.PNC", "PNC")
                        .WithMany()
                        .HasForeignKey("PNCId")
